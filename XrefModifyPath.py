...
for block_guid in block_guids:
    ...
    sc.doc.InstanceDefinitions.ModifySourceArchive(block_idx,
                            ...
                            1)
    block_file_name = os.path.basename(os.path.splitext(block_obj.InstanceDefinition.SourceArchive)[0])
    rs.RenameBlock(block_obj.InstanceDefinition.Name, block_file_name) 